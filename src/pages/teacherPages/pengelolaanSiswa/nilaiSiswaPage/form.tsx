...
export const FormNilaiSiswaPage: React.FC = () => {
  ...
  return (
    <>
      <HeaderTitlePage title={`${id ? "Update" : "Tambah"} Nilai Siswa`} subTitle="Nilai Siswa SMKN 1 Lumban Julu" backDisplay={true} addDisplay={false} linkAdd="" />
      <div
